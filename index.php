...
<body>
	<div class="container">
		<header class="page-header">
			<a href="./" class="reset"><h1>
					超うんこなサイト<small>うんこでも気づいたこと書きます</small>
				</h1> </a>
		</header>
		<div class="visible-phone" id="menu-button">
			<button class="btn" id="menu-toggle">メニュー</button>
		</div>
		<div class="row">
			<div class="span2" id="menu">
				<ul class="nav nav-list">
					<li class="nav-header">タグ</li>
				</ul>
				<div id="tags-li"></div>
				<ul class="nav nav-list">
					<li class="divider"></li>
					<li><a href="?p=About" class="ajax">About</a>
					</li>
					<li>
						<button class="btn btn-primary new"
							href="./data/edit-article.html">記事の追加</button>
					</li>
				</ul>
			</div>
			...
			<footer> Copyright(c) kumar8600 </footer>
		</div>
